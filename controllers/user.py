...
def clean_name(s:str)->str:
    '''Clean the club name into a valid filename format'''
...
class UserScraper(BaseScraper):
    ...
    def scrape_users(self, clubs:list)->None:
        """
        Scrape Users
        ...
        for club in clubs:
            ...
            for page in range(pages):
                ...
                print(len(users))
                users.to_csv(f'./data/users/{clean_name(club["name"])}.csv', mode="a", sep=";", header=1 if page==0 else 0)
